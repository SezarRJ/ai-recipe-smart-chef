      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-display font-bold text-gray-800 mb-2">Subscription Plans</h1>
            <p className="text-gray-600">Choose the perfect plan for your culinary journey</p>
          </div>
        </motion.div>
