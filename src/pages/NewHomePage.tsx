...
const NewHomePage = () => {
  // Define the quick actions data
  const quickActionsCookingPlanning = [
    { path: '/recipes', icon: <ChefHat className="h-5 w-5" />, label: 'Recipes' },
    { path: '/meal-plan', icon: <Calendar className="h-5 w-5" />, label: 'Meal Plan' },
    { path: '/shopping-lists', icon: <ShoppingCart className="h-5 w-5" />, label: 'Shopping' },
  ];

  const quickActionsCommunityRewards = [
    { path: '/community', icon: <Users className="h-5 w-5" />, label: 'Community' },
    { path: '/loyalty', icon: <Gift className="h-5 w-5" />, label: 'Rewards' },
    { path: '/challenges', icon: <Trophy className="h-5 w-5" />, label: 'Challenges' },
  ];
